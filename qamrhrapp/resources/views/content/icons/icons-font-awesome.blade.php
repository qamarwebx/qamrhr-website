...
<div class="d-flex justify-content-center mx-auto gap-4">
  ...
  <a href="{{config('variables.documentation')}}/Icons" class="btn btn-primary" target="_blank">How to use icons?</a>
</div>
@endsection
