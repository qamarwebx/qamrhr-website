google.maps.__gjsload__('common', function(_) {
    ...
    Nv = function(a, b) {
        const c = Lv(a.Fg.bl());
        var d = b.Kh.shiftKey;
        d = a.Hg && 1 === c.fm && a.Fg.Qi.CE || d && a.Fg.Qi.NH || a.Fg.Qi.rp;
    ...
    _.vv = class {
        ...
        Mg(a, b, c, d) {
            ...
            }), this.Jg).call(this, Ida(d, b, c)).then(f => f.qH)
        }
        Fg(a, b, c, d) {
    ...
    var rea = class {
        ...
        aha = class {
            ...
            lk(a) {
                ...
                this.Fg.Qi.Ty && a.Fg && a.Fg();
                return this.Hg || b ? new CB(this.Fg) : new bha(this.Fg, this.Gg, this.Jg)
            }
            kl() {}
            Hp() {
                if (this.Fg.Qi.BG && 3 !== this.Jg && this.Fg.Qi.BG(this.Gg)) return new Mv(this.Fg)
            }
        },
        Mv = class {
            constructor(a) {
        ...
        bha = class {
            ...
            Yj(a) {
                ...
                !b && this.Fg.Qi.Px && this.Fg.Qi.Px(this.Hg, this.Gg);
                return Ev(a) ? new Mv(this.Fg) : new aha(this.Fg, b, a.button)
            }
            Qk() {}
            lk() {}
            Hp() {
                this.Fg.Qi.Px && this.Fg.Qi.Px(this.Hg, this.Gg);
        ...
        Ng(a) {
            ...
            if (this.ownerElement.contains(this.element)) {
                ...
                var b = Zv(this, document.body),
                    c = a.target,
                    d = uea(this, b);
                a.target === this.Fg ? (c = d.zF, a = d.mx, d = d.SA, this.element.contains(this.Hg) ? (--c, 0 <= c ? aw(b[c]) : aw(b[d - 1])) : aw(b[a + 1])) : a.target === this.Gg ? (c = d.mx, a = d.SA, d = d.AF, this.element.contains(this.Hg) ? (d += 1, d < b.length ? aw(b[d]) : aw(b[c + 1])) : aw(b[a - 1])) : (d = d.mx,
    ...
    _.GB = class {
        ...
        Si(a, b, c, d, e, f, g,
            ...
            n = 1 === this.Jg.Ok && e && this.lh.Sw(e) || a;
            l = this.Jg.mi;
    ...
    _.dC = cC;
    _.eC = "https://www.google.com" + (_.Li ? ["/intl/", _.Li.Fg().Fg(), "_", _.Ki(_.Li.Fg())].join("") : "") + "/help/terms_maps";
    _.$B = new $ha((a, b) => {
    ...
    _.mia = class {
        constructor(a) {
            ...
            a.Ky ? rA(this.gn) : (this.gn.style.position = "absolute", this.gn.style.left = this.gn.style.top = "0", this.gn.style.width = "100%");
            this.Gg = null;
            a.dA && (this.Ho = _.Df("DIV"), this.Ho.style.zIndex =
                3, d.appendChild(this.Ho), qA(this.Ho), this.Gg = _.Df("DIV"), this.Gg.style.zIndex = 4, d.appendChild(this.Gg), qA(this.Gg), a.Mk && (this.Ho.style.backgroundColor = "rgba(255,255,255,0)"), this.Sn = _.Df("DIV"), this.Sn.style.zIndex = 4, a.Ky ? (this.Ho.appendChild(this.Sn), rA(this.Sn)) : (d.appendChild(this.Sn), this.Sn.style.position = "absolute", this.Sn.style.left = this.Sn.style.top = "0", this.Sn.style.width = "100%"));
            this.bn = d;
            this.Fg = c;
            this.Kj = e;
